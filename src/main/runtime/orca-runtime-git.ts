import { RuntimeGitBranchCleanupCommands } from './runtime-git-branch-cleanup-commands'
...
export class RuntimeGitCommands {
  ...
  readonly getRuntimeGitBranchReturnState: RuntimeGitBranchCleanupCommands['getRuntimeGitBranchReturnState']
  readonly deleteRuntimeGitBranch: RuntimeGitBranchCleanupCommands['deleteRuntimeGitBranch']
  ...
  constructor(host: RuntimeGitCommandHost) {
    ...
    const branchCleanup = new RuntimeGitBranchCleanupCommands(host)
    ...
    this.getRuntimeGitBranchReturnState =
      branchCleanup.getRuntimeGitBranchReturnState.bind(branchCleanup)
    this.deleteRuntimeGitBranch = branchCleanup.deleteRuntimeGitBranch.bind(branchCleanup)
