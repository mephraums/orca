...
export function installRuntimeGitCommandSurface(
  ...
  Object.assign(target, {
    ...
    getRuntimeGitBranchReturnState: commands.getRuntimeGitBranchReturnState.bind(commands),
    deleteRuntimeGitBranch: commands.deleteRuntimeGitBranch.bind(commands),
