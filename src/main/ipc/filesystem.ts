...
import { registerFilesystemGitBranchCleanupHandlers } from './filesystem/filesystem-git-branch-cleanup-handlers'
...
export function registerFilesystemHandlers(
  ...
  registerFilesystemGitBranchCleanupHandlers(context)
