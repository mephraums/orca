...
import { TaskPageGitHubPrBatchBar, TaskPageGitHubPrToolbarToggles } from './PrBatchControls'
  ...
  return (
    ...
    >
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-2">
        ...
        >
          {showPRManagementColumns ? (
            <TaskPageGitHubPrToolbarToggles batch={prBatchSelection} />
          ) : null}
          <Tooltip>
      ...
      <TaskPageGitHubPrBatchBar batch={prBatchSelection} />
