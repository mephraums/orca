...
import { WorktreeContextMenuGitSyncItems } from './WorktreeContextMenuGitSyncItems'
import { WorktreeContextMenuPrimaryBranchItems } from './WorktreeContextMenuPrimaryBranchItems'
import {
        ...
        >
          ...
          {!isMultiContext && (
            <>
              ...
              <WorktreeContextMenuGitSyncItems
                worktree={worktree}
                repo={repo}
          ...
          />
          <WorktreeContextMenuPrimaryBranchItems
            worktree={worktree}
            connectionId={repo?.connectionId ?? null}
